...
export function MyNotification({username, journalTitle, journalDate, timestamp}) {
    let timestampAsDate = new Date(timestamp);
    let timestampHourMinutes = timestampAsDate.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit'});
    return (
