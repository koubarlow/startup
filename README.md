...
- [X] **Stores data in MongoDB** - Stores users and journals, updates journal reads and user tokens
- [X] **Stores credentials in MongoDB** - Stores username, encrypted password, user tokens, and logs out successfully
